                                          ...
                                          : CSubPage(parent,widget,wndMain), m_bRfidWork(false)
{
    ...
    switch(instanceType)
    {
    case 0: // ylf: 20200814, seems fixed to 0
        initManualItem();
        break;
    default:
        initNormalItem();
...
void ConsumableInsPage::initNormalItem()
{
    ...
    {
        aIds[iIdx].iType = APP_ACCESSORY_TYPE_CMAT;
    ...
    case MACHINE_L_EDI_LOOP:
    case MACHINE_L_RO_LOOP:
        aIds[iIdx].iType = APP_ACCESSORY_TYPE_MACH; 
...
void ConsumableInsPage::initManualItem()
{
    ...
    aIds[iIdx].iType = APP_ACCESSORY_TYPE_MACH; //0
    aIds[iIdx].iId   = DISP_MACHINERY_SOURCE_BOOSTER_PUMP;
    aIds[iIdx].iRfid = APP_RFID_SUB_TYPE_ROPACK_OTHERS;
    iIdx++;
