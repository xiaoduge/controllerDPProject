...
void SysTestPage::update()
{
    unsigned char buf[1];
    buf[0] = 1;
    m_wndMain->m_pCcb->DispCmdEntry(DISP_CMD_ENG_MODE,buf,1);
}
    ...
    case SYSTEM_TEST_ITEM_TYPE_SWITCH_AND_VALUE:
        {
            ...
            buf[iIdx++] = state ? 1 : 0;
            hdl = m_wndMain->m_pCcb->DispCmdEntry(DISP_CMD_ENG_CMD,buf,iIdx);
    ...
    case SYSTEM_TEST_ITEM_TYPE_HO_SWITCH:
        {
            ...
            if (hdl)
            {
                m_wndMain->m_pCcb->DispSndHoSystemTest(hdl->address - APP_HAND_SET_BEGIN_ADDRESS,state,APP_PACKET_HO_SYS_TEST_TYPE_TEST);
            }
        }
        break;
    }
...
void SysTestPage::on_item_cmb_changed(int value)
{
    ...
    case 1: 
        /* Low speed */
        tmp = m_wndMain->m_pCcb->DispConvertVoltage2RPumpSpeed(12);
        break;
    case 2: 
        /* Medium speed */
        tmp = m_wndMain->m_pCcb->DispConvertVoltage2RPumpSpeed(18);
        
        break;
    case 3: 
        /* High speed */
        tmp = m_wndMain->m_pCcb->DispConvertVoltage2RPumpSpeed(24);
        break;
    default:
        break;
    }
