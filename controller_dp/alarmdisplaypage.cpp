...
//                strTmp = tr("Replace in ") + decodeDays(tmp) + tr(" ") + tr("days");
        ...
        case DISP_ROC12:
            ...
            {
                strTmp = tr("Last Maintenance ") + decodeTime(gGlobalParam.CleanParam.aCleans[APP_CLEAN_RO].lstTime);
                m_pCslistItem[iIdx]->setInstDate(strTmp);

                QDateTime lstDateTime = QDateTime::fromTime_t(gGlobalParam.CleanParam.aCleans[APP_CLEAN_RO].period);
