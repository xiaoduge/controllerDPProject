...
void SystemMonitorPage::update()
{
    ...
    m_ulSwitchMask = m_wndMain->m_pCcb->DispGetSwitchState(APP_EXE_SWITCHS_MASK);
        ...
        case SYSTEMPAGE_ITEM_NAME_N1N2_STATE:
            {
                ...
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_N1_NO,&iTmpData);
                ...
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_N2_NO,&iTmpData);
        ...
        case SYSTEMPAGE_ITEM_NAME_N3T1_STATE:
            {
                ...
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_N3_NO,&iTmpData);
                m_apSysMonitorListItem[iLoop]->setSwitch1(m_ulSwitchMask & (1 << APP_EXE_N3_NO) ? true : false);
                strTemp.sprintf("%d mA",iTmpData);
                m_apSysMonitorListItem[iLoop]->setValue1(strTemp);
                
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_T1_NO,&iTmpData);
        ...
        case SYSTEMPAGE_ITEM_NAME_C3C4_STATE:
            {
                int iTmpData;
                QString strTemp;
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_C3_NO,&iTmpData);
                m_apSysMonitorListItem[iLoop]->setSwitch1(m_ulSwitchMask & (1 << APP_EXE_C3_NO) ? true : false);
                strTemp.sprintf("%d mA",iTmpData);
                m_apSysMonitorListItem[iLoop]->setValue1(strTemp);
                
                m_wndMain->m_pCcb->DispGetOtherCurrent(APP_EXE_C4_NO,&iTmpData);
        ...
        case SYSTEMPAGE_ITEM_NAME_C1_STATE:
            {
                ...
                m_wndMain->m_pCcb->DispGetRPumpRti(APP_EXE_C1_NO,&iTmpDataV,&iTmpDataI);
        ...
        case SYSTEMPAGE_ITEM_NAME_C2_STATE:
            {
                ...
                m_wndMain->m_pCcb->DispGetRPumpRti(APP_EXE_C2_NO,&iTmpDataV,&iTmpDataI);
    ...
    }
    {
        ...
        cmd->iRptFlag = 1;
        m_wndMain->m_pCcb->DispCmdEntry(DISP_CMD_SWITCH_REPORT,buf,sizeof(DISP_CMD_SWITCH_STATE_REPORT_STRU));
    }        
}
...
{
   unsigned int ulTempMaks = m_wndMain->m_pCcb->DispGetSwitchState(APP_EXE_SWITCHS_MASK);
...
void SystemMonitorPage::updateRpumpInfo(int iChl)
{
    ...
    unsigned int ulSwitchMask = m_wndMain->m_pCcb->DispGetSwitchState(APP_EXE_SWITCHS_MASK);
...
void SystemMonitorPage::updateWorkState()
{
   ...
   case DISP_WORK_STATE_IDLE:
        if (m_wndMain->m_pCcb->DispGetFwFlag())
        {
