...
void DManagerSetPage::update()
{
    ...
    {
        m_pCaliS1LineEdit->setText(QString::number(gGlobalParam.Caliparam.pc[m_caliId].fk));
    }
    else
    {
        m_pCaliS1LineEdit->setText(QString::number(gGlobalParam.Caliparam.pc[m_caliId].fk,'f',3));
    }
